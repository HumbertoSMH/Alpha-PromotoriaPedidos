...
import promotoria.grocus.mx.promotoriapedidos.controller.DisplayErrorActivity;

/**
 * Created by devmac03 on 03/06/15.
 */
public class CustomUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    private final static String CLASSNAME =  CustomUncaughtExceptionHandler.class.getSimpleName();
    ...
    public void uncaughtException(Thread thread, Throwable exception) {
        ...
        LogUtil.printLog( CLASSNAME , "Exception: " + exception.getMessage()  );
        LogUtil.printLog( CLASSNAME , "Exception: " + stackTrace.toString()  );
